...
### Persistent Filter
Because the amount of cards on each homepage varies, we added a persistent filter box to quickly find any card.
...
### Speed trumps all
What good are pretty transitions and Dribbble-worthy UI if the product is too slow? 
{{ end-block }}
{{ end-block }}
